...
BeginPackage["TeXExporter`"];

(* Shortcut for inputing Zotero references to Mathematica *)
FrontEndExecute[
 FrontEnd`AddMenuCommands[
  "DuplicatePreviousOutput", {Delimiter, 
   MenuItem["Zotero link", 
    FrontEndExecute @ Module[{nb, clip}, clip = Evaluate@ToExpression[NotebookGet[ClipboardNotebook[]][[1, 1, 1]]];
