...
BeginPackage["AnkiExporter`",{"ScienceNotebooks`"}];

(*Highlight Selection  key shortcut and menu*)
FrontEndExecute[
 FrontEnd`AddMenuCommands[
  "DuplicatePreviousOutput", {Delimiter, 
   MenuItem["Anki Highlight",FrontEndExecute[AnkiExporter`AnkiHighlight[]], System`MenuKey["d", System`Modifiers -> {"Command"}], 
...
AnkiHighlight[]:=Module[{nb, t}, nb = InputNotebook[];
